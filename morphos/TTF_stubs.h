...
#define STUB(name) extern int LIB_##name();
	...
	STUB(TTF_RenderText_LCD)
	STUB(TTF_RenderUTF8_LCD)
	STUB(TTF_RenderUNICODE_LCD)
	STUB(TTF_RenderText_LCD_Wrapped)
	STUB(TTF_RenderUTF8_LCD_Wrapped)
	STUB(TTF_RenderUNICODE_LCD_Wrapped)
	STUB(TTF_RenderGlyph_LCD)
	STUB(TTF_RenderGlyph32_LCD)
	STUB(TTF_SetFontDirection)
	STUB(TTF_SetFontScriptName)
	STUB(TTF_GetFontWrappedAlign)
	STUB(TTF_SetFontWrappedAlign)